...
SECRET_KEY = 'django-insecure-(2srb-mcl&t##c)122b!vv4-b!j5i9gt-j=^!m+zisu(hc^(kw'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'stellarproject', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
